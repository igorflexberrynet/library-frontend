      ...
      nodes: [
        {
          ...
          link: null,
          caption: i18n.t('forms.application.sitemap.library.caption'),
          title: i18n.t('forms.application.sitemap.library.title'),
          children: [{
            link: 'i-i-s-library-book-l',
            caption: i18n.t('forms.application.sitemap.library.i-i-s-library-book-l.caption'),
            title: i18n.t('forms.application.sitemap.library.i-i-s-library-book-l.title'),
            children: null
          }]
        }
      ]
